...
var SendQueue = [];
const SupportedIndexers = ['*.newz-complex.org','*.animenzb.com','*.dognzb.cr','*.nzbs.org','*.pfmonkey.com','*.nzb.su','*.nzbindex.nl','*.nzbindex.com','*.nzbclub.com','*.nmatrix.co.za', '*.althub.co.za','*.oznzb.com','*.binsearch.info','*.binsearch.net','*.nzbgeek.info','*.nzbplanet.net','*.usenet-crawler.com'];
